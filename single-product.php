<?php
include("modele.php");
extract($_GET);//$id=2 dans le lien
...
<html lang="en">
  <head>
    ...
    <title>concsultation de <?=$produit['libelle'];?></title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>details du Produit   <?=$produit['libelle'];?></h2>
              ...
              <ul class="list">
                <li>
                  <a class="active" href="#">
                    ...
                    <?php 
                  $cat=  find($produit['categorie_id'],"categorie");
                    echo $cat['nom'];
                    ?>
                    </a
                  >
